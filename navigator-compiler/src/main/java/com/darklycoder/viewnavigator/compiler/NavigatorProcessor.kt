package com.darklycoder.viewnavigator.compiler
...
class NavigatorProcessor : AbstractProcessor() {
    ...
    private fun generate(list: ArrayList<NavigatorInfo>) {
        val pkgName = "com.darklycoder.viewnavigator"
        val clsName = "ViewPaths"

        val navigatorInfo = ClassName("com.darklycoder.viewnavigator.info", "NavigatorInfo")
